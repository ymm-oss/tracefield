...
| [`design-archive.md`](./design-archive.md) | **Archive（仮称）設計**。ドキュメント接地＋検証可能な引用で C5 の過剰隔離(precision)を解決する再設計。Field Actor の sensitivity profile 具体化 | C5 を実用化する次設計を知りたい |
